#!/usr/bin/env python3
"""Generate an informative index of all SASD C#/.NET profile requirements."""
...
def generate(repo: Path) -> str:
    ...
    body = ["---", 'title: "C#/.NET Requirements Index"', "document-id: SASD-REF-DOTNET-004",
            "document-type: informative", "status: Draft", "version: 0.4.0",
            ...
            "applies-to-profiles: [DotNet]", "depends-on: [SASD-PROF-DOTNET-001]",
            "generated: true", "---", "", "# C#/.NET Requirements Index", "",
...
def main() -> int:
    ...
    target = repo / "docs" / "20-profiles" / "dotnet" / "DOTNET-REQUIREMENTS-INDEX.md"
